...
interface ICerosRouter {
  ...
  // in aBNBc
  function depositABNBc(address owner, uint256 amount) external returns (uint256);
  ...
  // BNB
  function withdrawWithSlippage(address recipient, uint256 amount) external returns (uint256);
