...
export interface CeTokenInterface extends utils.Interface {
  functions: {
    ...
    "getVaultAddress()": FunctionFragment;
...
export interface CeToken extends BaseContract {
  ...
  functions: {
    ...
    getVaultAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getVaultAddress(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getVaultAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
