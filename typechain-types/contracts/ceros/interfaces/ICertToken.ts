...
export interface ICertTokenInterface extends utils.Interface {
  functions: {
    "allowance(address,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "balanceWithRewardsOf(address)": FunctionFragment;
    "burn(address,uint256)": FunctionFragment;
    "isRebasing()": FunctionFragment;
...
export interface ICertToken extends BaseContract {
  ...
  callStatic: {
    ...
    isRebasing(overrides?: CallOverrides): Promise<boolean>;
