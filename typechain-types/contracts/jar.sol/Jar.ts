...
export interface JarInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "redeemable", values: [string]): string;
  ...
  encodeFunctionData(functionFragment: "tpsPaid", values: [string]): string;
...
export type ExitDelayUpdatedEvent = TypedEvent<
  [BigNumber],
  ExitDelayUpdatedEventObject
>;

export type ExitDelayUpdatedEventFilter =
  TypedEventFilter<ExitDelayUpdatedEvent>;
...
export type SpreadUpdatedEvent = TypedEvent<
  [BigNumber],
  SpreadUpdatedEventObject
>;
...
export interface Jar extends BaseContract {
  ...
  functions: {
    ...
    tpsPaid(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  redeemable(account: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    setSpread(_spread: BigNumberish, overrides?: CallOverrides): Promise<void>;
